...
export const Card = ({
  ...
  return (
    (<div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-gray-100 border border-transparent dark:border-white/[0.2] relative z-20",
        className
      )}>
...
export const CardDescription = ({
  ...
  return (
    (<p
      className={cn("mt-8 text-zinc-800 tracking-wide leading-relaxed text-sm", className)}>
      {children}
    </p>)
  );
};
